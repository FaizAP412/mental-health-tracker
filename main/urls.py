...
from main.views import show_main, create_mood_entry, login_user, register, show_xml, show_json, show_xml_by_id, show_json_by_id
from main.views import logout_user, delete_mood, edit_mood, add_mood_entry_ajax, create_mood_flutter
